    ...
    <div class="section section-gray">
        <div class="container">
            <div class="section">
                    ...
                    <div>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">   
                                ...
                                <div class="form-group">
                                    <label for="name">Postal Code</label> <form:errors path="shippingAddress.postalCode" cssStyle="color:#EA1E63;" />
                ...
                </div>          <button class="btn btn-danger" name="_eventId_backToCollectCustomerInfo">Cancel</button>
                                <input type="submit" value="Next"  name="_eventId_shippingDetailCollected" class="btn btn-primary btn-round" />
