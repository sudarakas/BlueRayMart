<%-- 
    Document   : editMovie
    Created on : Jun 5, 2019, 4:03:24 PM
    Author     : NanoX
--%>
            ...
            <div class="section">
                <div class="container">
                    <div class="col-md-10 col-md-offset-1">
                        <form:form action="${pageContext.request.contextPath}/admin/inventory/editMovie" method="post" commandName="movie" enctype="multipart/form-data">
                            <form:hidden path="movieId" value="${movie.movieId}" class="form-control" />
                            <div class="form-group">
                                <label for="name">Movie Name</label>
                                <form:input path="movieName" type="text" value="${movie.movieName}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Movie Genre</label>
                                <form:select path="movieGenre" class="selectpicker" data-style="select-with-transition" value="${movie.movieGenre}" title="${movie.movieGenre}">
                            ...
                            <div class="form-group">
                                ...
                                <form:select path="movieFormat" class="selectpicker" data-style="select-with-transition" value="${movie.movieFormat}" title="${movie.movieFormat}">
                            ...
                            <div class="form-group">
                                ...
                                <form:input path="movieDirector" type="text" value="${movie.movieDirector}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Studio</label>
                                <form:input path="movieStudio" type="text" value="${movie.movieStudio}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Release Date</label>
                                <form:input path="movieReleaseDate" type="date" value="${movie.movieReleaseDate}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Movie Original Language</label>
                                <form:input path="movieOriginalLanguage" type="text" value="${movie.movieOriginalLanguage}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Movie Language</label>
                                <form:input path="movieLanguage" type="text" value="${movie.movieLanguage}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Run Time</label>
                                <form:input path="movieRunTime" type="text" value="${movie.movieRunTime}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">IMDB URL</label>
                                <form:input path="movieIMDB" type="text" value="${movie.movieIMDB}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Description</label>
                                <form:textarea path="movieDescription" type="text" value="${movie.movieDescription}" class="form-control" rows="5" />
                            </div>
                            <div class="form-group">
                                <label for="name">Price</label>
                                <form:input path="moviePrice" type="text" value="${movie.moviePrice}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Unit in Stock</label>
                                <form:input path="movieUnitinStock" type="number" value="${movie.movieUnitinStock}" class="form-control" />
                            </div>
                            <div class="form-group">
                                <label for="name">Status</label>
                                <form:select path="movieStatus" class="selectpicker" data-style="select-with-transition" value="${movie.movieStatus}" title="${movie.movieStatus}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail img-raised">
                                        <img src="<c:url value="/resources/images/${movie.movieId}.png"/>" alt="..." style="width: 300px;height: 400px;">
                                    </div>                 
